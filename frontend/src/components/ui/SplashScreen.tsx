        ...
        >
          <div className="relative">
            ...
            <div className="relative flex items-center justify-center">
              <div className="w-32 h-32 md:w-36 md:h-36 rounded-2xl bg-emerald-950 flex items-center justify-center ring-2 ring-white/10 relative">
                <span className="text-3xl font-black text-emerald-400">{nama?.charAt(0) || 'A'}</span>
                <img
                  src={logo || '/logo.jpg'}
