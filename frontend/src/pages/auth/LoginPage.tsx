    ...
    <div className={`min-h-screen overflow-hidden relative flex items-center justify-center p-4 transition-colors ${isDark ? 'bg-black' : 'bg-slate-50'}`}>
      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="text-center mb-8">
          <div className={`w-14 h-14 rounded-2xl flex items-center justify-center mx-auto mb-4 animate-float ${isDark ? 'bg-gradient-to-br from-emerald-400 to-emerald-600 shadow-lg shadow-emerald-500/25' : 'bg-gradient-to-br from-emerald-500 to-emerald-700 shadow-lg shadow-emerald-500/30'}`}>
